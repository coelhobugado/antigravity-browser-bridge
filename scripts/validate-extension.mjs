...
try {
  ...
  const requiredFiles = ["manifest.json", "background.js", "content.js", "icons/icon-16.png", "icons/icon-32.png", "icons/icon-48.png", "icons/icon-128.png"];
  for (const relative of requiredFiles) {
    if (!fs.existsSync(path.join(extensionDir, relative))) throw new Error(`missing ${relative}`);
  }

  for (const source of ["background.js", "content.js"]) {
